...
function BottomSheet({
  ...
  const backgroundColorSheetStyle = {
    backgroundColor:
      currentTheme === "dark"
        ? ColorsRevised.darkgrayBackground
        : ColorsRevised.white,
  };
...
const EditProfileScreen = () => {
  ...
  const handleUpdateProfilePicture = async (imageUri?: string) => {
    try {
      ...
      const updatedProfile = await uploadProfilePicture.mutateAsync(
        uriToUpload
      );
    ...
    return (
      <SafeAreaView
        style={{
          flex: 1,
          backgroundColor:
            currentTheme === "dark" ? ColorsRevised.dark : ColorsRevised.white,
        }}
      >
      ...
      >
        <View style={styles.shutterContainer}>
          <Pressable
            ...
            style={{ opacity: facing === "front" ? 0.5 : 1 }}
          >
            {flash === "off"
