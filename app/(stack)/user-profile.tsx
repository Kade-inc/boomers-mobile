...
import { Member } from '@/entities/TeamDetails';
...
export default function UserProfileScreen() {
  ...
  const {user} = useAuth();
  const route = useRoute<RouteProp<MembersRouteParams, "Member">>();
  const userId = route.params.userId;

  const {data: userTeamsData, refetch: refetchUserTeams, isPending: isTeamsLoading, isError: isTeamsError, isRefetching: isTeamsRefetching} = useGetUserTeams(userId || '')
